...
namespace IdentityServer.UnitTests.Hosting
{
    ...
    {
        private Dictionary<string, IdentityServerX.Hosting.Endpoint> _pathMap;
        private List<IdentityServerX.Hosting.Endpoint> _endpoints;
        private IdentityServerOptions _options;
        private EndpointRouter _subject;

        public EndpointRouterTests()
        {
            _pathMap = new Dictionary<string, IdentityServerX.Hosting.Endpoint>();
            _endpoints = new List<IdentityServerX.Hosting.Endpoint>();
        ...
        {
            Action a = () => new IdentityServerX.Hosting.Endpoint("ep1", "ep1", typeof(MyEndpointHandler));
        ...
        {
            _endpoints.Add(new IdentityServerX.Hosting.Endpoint("ep1", "/ep1", typeof(MyEndpointHandler)));
            _endpoints.Add(new IdentityServerX.Hosting.Endpoint("ep2", "/ep2", typeof(MyOtherEndpointHandler)));
        ...
        {
            _endpoints.Add(new IdentityServerX.Hosting.Endpoint("ep1", "/ep1", typeof(MyEndpointHandler)));
            _endpoints.Add(new IdentityServerX.Hosting.Endpoint("ep1", "/ep1", typeof(MyOtherEndpointHandler)));
        ...
        {
            _endpoints.Add(new IdentityServerX.Hosting.Endpoint(EndpointNames.Authorize, "/ep1", typeof(MyEndpointHandler)));
            _endpoints.Add(new IdentityServerX.Hosting.Endpoint("ep2", "/ep2", typeof(MyOtherEndpointHandler)));
