...
namespace IdentityServerX.ResponseHandling
{
    ...
    /// </summary>
    /// <seealso cref="IdentityServerX.ResponseHandling.IDiscoveryResponseGenerator" />
    public class DiscoveryResponseGenerator : IDiscoveryResponseGenerator
    {
        ...
        public virtual async Task<Dictionary<string, object>> CreateDiscoveryDocumentAsync(string baseUrl, string issuerUri)
        {
            ...
            // custom entries
            if (!IdentityServerX.Extensions.IEnumerableExtensions.IsNullOrEmpty(Options.Discovery.CustomEntries))
            {
