iex ((New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/IdentityServer/IdentityServerX.Quickstart.UI.AspNetIdentity/main/getmain.ps1'))	
